    ...
    def run(self):
        ...
        while True:
            ...
            if next_task == None:
                ...
                sys.stdout.write('\r')
                sys.stdout.write("{n} files remaining to process. Estimated time remaining: {est_time:.2f} minutes. Last chunk took {write_time:.2f} seconds/file to write.".format(n=self.num_files_remaining, est_time=self.est_time_remaining, write_time = self.last_write_time/self.chunksize))
                sys.stdout.flush()
