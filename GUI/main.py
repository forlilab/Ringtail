...
class Ui_MainWindow(object):
        def __init__(self): 
            # setup_logger(debug=False, verbose=True)        
                self.window = None
        ...
        def setupUi(self, MainWindow):
            ...
            self.gridLayout_2.addWidget(self.writeInteractionsGroupBox, 0, 1, 1, 1)
            
            # Logger
            self.writeLoggerGroupBox = QtWidgets.QGroupBox(self.writeTab)
            self.loggerGrid = QtWidgets.QGridLayout(self.writeLoggerGroupBox)
            self.loggerGrid.setObjectName("loggerGrid")
            sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
            sizePolicy.setHorizontalStretch(0)
            sizePolicy.setVerticalStretch(0)
            sizePolicy.setHeightForWidth(self.writeLoggerGroupBox.sizePolicy().hasHeightForWidth())
            self.writeLoggerGroupBox.setSizePolicy(sizePolicy)
            self.writeLoggerGroupBox.setObjectName("writeLoggerGroupBox")
            self.loggerWidget = QTextEditLogger(self.writeLoggerGroupBox)
            self.loggerWidget.setFormatter(logging.Formatter('%(asctime)s - %(levelname)s - %(message)s'))
            logging.getLogger().addHandler(self.loggerWidget)
            logging.getLogger().setLevel(logging.DEBUG)
            self.loggerGrid.addWidget(self.loggerWidget.widget, 0, 0, 1, 1)
            self.gridLayout_2.addWidget(self.writeLoggerGroupBox, 1, 1, 1, 1)
            ...
            self.gridLayout_8.addWidget(self.resultsGroupbox, 0, 1, 5, 1)
            ...
            self.gridLayout_8.addWidget(self.readLigandsGroupBox, 1, 0, 2, 1)
            ...
            self.gridLayout_8.addWidget(self.readInteractionsGroupBox, 3, 0, 1, 1)
            ...
            self.gridLayout_8.addWidget(self.readProceedButton, 4, 0, 1, 1)
            ...
            # self.readLigandListWidget.currentRowChanged.connect(self.sanity_check_filters)
        ...
        def set_engine(self):
            ...
            if self.selected_engine == 'AutoDock-GPU':
                logging.debug("Set AutoDock-GPU engine")
                        ...
                        if self.ligand_ui.exec_():
                            ...
                            if self.ligand_filter is not None:
                                ...
                                if self.ligand_filter.enabled:
                                    self.readLigandListWidget.item(idx).setIcon(QtCore.Qt.DisplayRole+1, QtGui.QIcon(":enabled_icon.svg"))
                                else:
                                    self.readLigandListWidget.item(idx).setIcon(QtCore.Qt.DisplayRole+1, QtGui.QIcon(":disabled_icon.svg"))
                        break
        ...
        def retranslateUi(self, MainWindow):
            ...
            self.writeLoggerGroupBox.setTitle(_translate("MainWindow", "Logger:"))
