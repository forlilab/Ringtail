...
class TestOutputs:
    ...
    def test_interaction_tolerance(self):
        ...
        conn = sqlite3.connect("output.db")
        cur = conn.cursor()
        cur.execute("SELECT * FROM Interaction_bitvectors WHERE Pose_ID in (SELECT Pose_ID FROM Results WHERE LigName LIKE 'OB3Z3759440327_RX1--4xfx_mon_prep--tyr169' AND run_number = 27)")
...
class TestFilters():
    def test_eworst(self):
        status = os.system("python ../scripts/run_ringtail.py --file_list filelist1.txt --eworst -15")
    ...
    def test_ebest(self):
        status = os.system("python ../scripts/run_ringtail.py --file_list filelist1.txt --ebest -15")
    ...
    def test_leworst(self):
        status = os.system("python ../scripts/run_ringtail.py --file_list filelist1.txt --leworst -0.4")
    ...
    def test_epercentile(self):
        status = os.system("python ../scripts/run_ringtail.py --file_list filelist1.txt --epercentile 0.1")
    ...
    def test_lepercentile(self):
        status = os.system("python ../scripts/run_ringtail.py --file_list filelist1.txt --leffpercentile 0.1")
    ...
    def test_name(self):
        status = os.system("python ../scripts/run_ringtail.py --file_list filelist1.txt --name OB3Z3759440327_RX1--4xfx_mon_prep--tyr169")
    ...
    def test_substruct(self):
        status = os.system("python ../scripts/run_ringtail.py --file_list filelist1.txt --substructure CO")
    ...
    def test_hbcount(self):
        status = os.system("python ../scripts/run_ringtail.py --file_list filelist1.txt --hb_count 5")
