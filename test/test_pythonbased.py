...
class TestReadOpts:
    def test_all_filters_python(self):
        ...
        filters = {'properties': {'eworst': -6.0, 'ebest': None, 'leworst': None, 'lebest': None, 'energy_percentile': None, 'le_percentile': None}, 'interactions': {'V': [], 'H': [], 'R': []}, 'interactions_count': [], 'ligand_filters': {'N': [], 'S': [], 'F': 'OR', 'X': []}, 'filter_ligands_flag': False, 'max_miss': 0, 'react_any': False}
