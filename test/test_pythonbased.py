...
class TestReadOpts:
    def test_all_filters_python(self):
        ...
        """filters = {'properties': {'eworst': -15.0, 'ebest': -16.0, 'leworst': -0.4, 'lebest': -0.5, 'score_percentile': None, 'le_percentile': None}, 'interactions': {'V': [('A:VAL:279:', True)], 'H': [('A:LYS:162:', True)], 'R': [('A:TYR:169:', True)]}, 'interactions_count': [('hb_count', 5)], 'ligand_filters': {'N': ['127458'], 'S': [], 'F': 'OR'}, 'filter_ligands_flag': True, 'max_miss': 0, 'react_any': True}"""
        filters = {'properties': {'eworst': -6.0, 'ebest': None, 'leworst': None, 'lebest': None, 'score_percentile': None, 'le_percentile': None}, 'interactions': {'V': [], 'H': [], 'R': []}, 'interactions_count': [], 'ligand_filters': {'N': [], 'S': [], 'F': 'OR', 'X': []}, 'filter_ligands_flag': False, 'max_miss': 0, 'react_any': False}
